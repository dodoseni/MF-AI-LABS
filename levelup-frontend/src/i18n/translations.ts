...
const en = {
  ...
  'certifications.subtitle':
    'Track your certification progress, discover required and recommended certifications, and mark your favourites.',
  ...
  'certifications.filter.favourites': 'Favourites',
  ...
  'certifications.favourite.add': 'Add to favourites',
  'certifications.favourite.remove': 'Remove from favourites',
...
const no: typeof en = {
  ...
  'certifications.subtitle':
    'Følg fremgangen på sertifiseringene dine, oppdag påkrevde og anbefalte sertifiseringer, og merk dine favoritter.',
  ...
  'certifications.filter.favourites': 'Favoritter',
  ...
  'certifications.favourite.add': 'Legg til i favoritter',
  'certifications.favourite.remove': 'Fjern fra favoritter',
